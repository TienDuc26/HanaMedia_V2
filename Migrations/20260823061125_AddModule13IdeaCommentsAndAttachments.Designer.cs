...
namespace HanaMedia.Migrations
{
    ...
    [Migration("20260823061125_AddModule13IdeaCommentsAndAttachments")]
    partial class AddModule13IdeaCommentsAndAttachments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HanaMedia.Models.Department", b =>
                {
                    ...
                    b.HasIndex(new[] { "Code" }, "UX_departments_code")
                        .IsUnique();
            ...
            modelBuilder.Entity("HanaMedia.Models.Idea", b =>
                {
                    ...
                    b.Property<string>("MoodboardFileUrl")
                        .HasMaxLength(255)
                        .IsUnicode(false)
                        .HasColumnType("varchar(255)")
            ...
            modelBuilder.Entity("HanaMedia.Models.IdeaComment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("HanaMedia.Models.WorkTask", b =>
                {
                    ...
                    b.HasIndex("AssignedEmployeeId", "Status")
                        .HasDatabaseName("idx_work_tasks_assignee_status");

                    b.HasIndex("Module", "Deadline")
                        .HasDatabaseName("idx_work_tasks_module_deadline");

                    b.ToTable("work_tasks", null, t =>
                        {
                            t.HasCheckConstraint("chk_work_task_module", "[module] IN ('Nhan_Su', 'Booking', 'Y_Tuong')");

                            t.HasCheckConstraint("chk_work_task_status", "[status] IN ('todo', 'in_progress', 'review', 'need_revision', 'approved', 'done')");
                        });
                });

            modelBuilder.Entity("HanaMedia.Models.WorkTaskHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("HanaMedia.Models.IdeaComment", b =>
                {
                    b.HasOne("HanaMedia.Models.User", "AuthorUser")
                        .WithMany()
            ...
            modelBuilder.Entity("HanaMedia.Models.WorkTask", b =>
                {
                    b.HasOne("HanaMedia.Models.Employee", "AssignedEmployee")
                    ...
                    b.HasOne("HanaMedia.Models.User", "ReviewerUser")
                        .WithMany("ReviewedWorkTasks")
            ...
            modelBuilder.Entity("HanaMedia.Models.WorkTaskHistory", b =>
                {
                    b.HasOne("HanaMedia.Models.User", "ActorUser")
                        .WithMany("WorkTaskHistoryEntries")
            ...
            modelBuilder.Entity("HanaMedia.Models.User", b =>
                {
                    ...
                    b.Navigation("ReviewedWorkTasks");

                    b.Navigation("SystemAuditLogs");

                    b.Navigation("WorkTaskHistoryEntries");
                });
